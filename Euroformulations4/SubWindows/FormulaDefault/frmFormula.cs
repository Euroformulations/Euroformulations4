...
namespace Euroformulations4.SubWindows
{
    public partial class frmFormula : Form
    {
        ...
        public void Cleartxt()
        {
            ...
            lattP.Text = "";
            Latt.Enabled = false;
            ModoficaFormula.Text = lang.GetWord("relatedTo");
            customer.Visible = false;
            listformularealeD.Rows.Clear();
            costototale.Text = "";
            ModoficaFormula.Visible = false;
        ...
        private void MainFormula_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                #region LICENZA
                if (GVar.attivazioni.Act__formulationRelatedTo) { customer.Visible = true; ModoficaFormula.Visible = true; } else { customer.Visible = false; ModoficaFormula.Visible = false; }
        ...
        private void customer_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (risultatiole.Read())
                {
                    ModoficaFormula.Text = risultatiole["nome"].ToString() + " " + risultatiole["cognome"].ToString();
                }
        ...
        private void EditFormula_Click(object sender, EventArgs e)
        {
            ...
            EditFormulaMenu.Show(ptLowerLeft);
        }
        ...
        private void gramsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                GVar.idFormulaModifica = calcolaFormula.idFormula;
                GVar.FormulaLattaggio = calcolaFormula.LattValue + "-" + calcolaFormula.LattUnit;
                GVar.FormulaType = "GRAMS";
                DOVESONO = "MODIFICADEFAULT";
                this.Close();
            }
            catch (Exception ex)
            {
